...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_3.addWidget(self.list_stim_profiles)
        ...
        brush1 = QBrush(QColor(60, 68, 84, 255))
        brush1.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Button, brush1)
        brush2 = QBrush(QColor(30, 34, 42, 255))
        brush2.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Light, brush2)
        brush3 = QBrush(QColor(45, 51, 63, 255))
        brush3.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Midlight, brush3)
        brush4 = QBrush(QColor(120, 136, 168, 255))
        brush4.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Dark, brush4)
        brush5 = QBrush(QColor(80, 90, 112, 255))
        brush5.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Mid, brush5)
        brush6 = QBrush(QColor(216, 222, 233, 255))
        ...
        palette.setBrush(QPalette.Active, QPalette.Highlight, brush11)
        brush12 = QBrush(QColor(46, 52, 64, 255))
        brush12.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.HighlightedText, brush12)
        brush13 = QBrush(QColor(94, 129, 172, 255))
        brush13.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Link, brush13)
        ...
        palette.setBrush(QPalette.Inactive, QPalette.NoRole, brush20)
        palette.setBrush(QPalette.Inactive, QPalette.ToolTipBase, brush17)
        palette.setBrush(QPalette.Inactive, QPalette.ToolTipText, brush18)
#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 0)
        ...
        palette.setBrush(QPalette.Disabled, QPalette.Shadow, brush21)
        ...
        palette.setBrush(QPalette.Disabled, QPalette.ToolTipText, brush18)
#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 0)
        ...
        self.label_status_value.setPalette(palette1)
        ...
        self.verticalLayout_5.addWidget(self.list_experiments_to_run)


        self.gridLayout_3.addWidget(self.groupBox_4, 2, 1, 2, 1)
        ...
        self.horizontalLayout_4.addWidget(self.btn_set_duration)
        ...
        sizePolicy9.setHeightForWidth(self.checkbox_start.sizePolicy().hasHeightForWidth())
        self.checkbox_start.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.btn_save_stim.sizePolicy().hasHeightForWidth())
        self.btn_save_stim.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.checkbox_end.sizePolicy().hasHeightForWidth())
        self.checkbox_end.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.btn_load_stim.sizePolicy().hasHeightForWidth())
        self.btn_load_stim.setSizePolicy(sizePolicy9)
        ...
        self.line_edit_LED_intensity = QLineEdit(self.groupBox_5)
        self.line_edit_LED_intensity.setObjectName(u"line_edit_LED_intensity")
        sizePolicy6.setHeightForWidth(self.line_edit_LED_intensity.sizePolicy().hasHeightForWidth())
        self.line_edit_LED_intensity.setSizePolicy(sizePolicy6)
        self.line_edit_LED_intensity.setLayoutDirection(Qt.LeftToRight)

        self.horizontalLayout_7.addWidget(self.line_edit_LED_intensity)
        ...
        sizePolicy9.setHeightForWidth(self.hslider_exp_LED.sizePolicy().hasHeightForWidth())
        self.hslider_exp_LED.setSizePolicy(sizePolicy9)
        ...
        self.gridLayout_7.setVerticalSpacing(120)
        self.label_8 = QLabel(self.tab_exp_settings)
        self.label_8.setObjectName(u"label_8")
        self.label_8.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_7.addWidget(self.label_8, 3, 2, 1, 1)

        self.spinBox = QSpinBox(self.tab_exp_settings)
        self.spinBox.setObjectName(u"spinBox")

        self.gridLayout_7.addWidget(self.spinBox, 3, 3, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.lineEdit, 1, 3, 1, 1)
        ...
        sizePolicy9.setHeightForWidth(self.comboBox.sizePolicy().hasHeightForWidth())
        self.comboBox.setSizePolicy(sizePolicy9)
        ...
        self.gridLayout_3.addWidget(self.tabWidget, 2, 2, 2, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(QCoreApplication.translate("MainWindow", u"Change Folder", None))
        ...
        self.line_edit_LED_intensity.setText(QCoreApplication.translate("MainWindow", u"0", None))
